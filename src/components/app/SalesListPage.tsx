    ...
    <div style={{ height: '100%', overflowY: 'auto', animation: 'scIn .25s ease both' }}>
      ...
      <div style={{ padding: '22px 26px 90px', maxWidth: 1280, margin: '0 auto' }}>
        ...
        {!frozen && showTrialEndingBanner && (
          <div style={{ marginBottom: 14, background: colors.warnBg, border: `1px solid ${colors.warnBorder}`, borderRadius: 12, padding: '12px 16px', display: 'flex', alignItems: 'center', gap: 12 }}>
