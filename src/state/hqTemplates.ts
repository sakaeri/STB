...
export const HQ_TEMPLATES: HqTemplate[] = [
  ...
  { id: 'community', label: '自治体・町内会', unitLabel: '班', hqNamePlaceholder: '例：〇〇町内会', teamNamePlaceholder: '例：1班', memoTopics: ['会員名簿', '行事予定', '会費徴収ルール'] },
  { id: 'pta', label: '学校PTA', unitLabel: '委員会', hqNamePlaceholder: '例：〇〇小学校PTA', teamNamePlaceholder: '例：広報委員会', memoTopics: ['委員名簿', '年間行事予定', '引継ぎ資料'] },
  { id: 'event', label: 'イベント運営', unitLabel: '班', hqNamePlaceholder: '例：〇〇実行委員会', teamNamePlaceholder: '例：受付班', memoTopics: ['当日タイムスケジュール', '役割分担', '緊急連絡先'] },
];
